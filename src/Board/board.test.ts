...
describe('Board', () => {
  ...
  it('should generate a random board', () => {
    ...
    // expect(randomBoard.bar.clockwise.checkers).toEqual([])
    // expect(randomBoard.bar.counterclockwise.checkers).toEqual([])
    // expect(randomBoard.off.clockwise.checkers).toEqual([])
    // expect(randomBoard.off.counterclockwise.checkers).toEqual([])
